...
class _DetailScreenState extends State<DetailScreen> {
  static List<ModelService> serviceProductLists = DataFile.serviceProductList;
  ...
  ListView buildListView(double defSpace) {
    return ListView.builder(
      ...
      primary: false,
      itemCount: serviceProductLists.length,
      itemBuilder: (context, index) {
        ModelService modelSalon = serviceProductLists[index];
        return Container(
  ...
  Column addButton(ModelService modelService, BuildContext context, int index) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.end,
      children: [
        if (modelService.quantity == 0)
          getButton(context, Colors.transparent, "Add", blueColor, () {
            modelService.quantity = (modelService.quantity! + 1);
            total = total + (modelService.price! * 1);
            DataFile.cartList[index.toString()] = ModelCart(
                modelService.image,
                modelService.name,
                modelService.productName,
                modelService.rating,
                modelService.price,
                modelService.quantity);
          ...
          Row(
            children: [
              ...
              getCustomFont(
                modelService.quantity.toString(),
                14,
                Colors.black,
                1,
        ...
        getCustomFont("\$${modelService.price}", 16, blueColor, 1,
            fontWeight: FontWeight.w900)
      ],
    );
  }

  Column packageDescription(ModelService modelSalon) {
    return Column(
  ...
  Container packageImage(BuildContext context, ModelService modelService) {
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          color: listColor,
          image: getDecorationAssetImage(context, modelService.image ?? "")),
    );
  }
  ...
  Column productDescription(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        getCustomFont("Car Repair", 24, Colors.black, 1,
            fontWeight: FontWeight.w900),
        ...
        Row(
          ...
          children: [
            ...
            getButton(
                context, Colors.white, "1K Bookings", blueColor, () {}, 14,
        ...
        getMultilineCustomFont(
            "There is a distinction between a mechanic and a licenced car repairer and although many small treatments, licenced car repairer provide extended services related to all kinds of vehincles.",
            16,
            Colors.black,
            fontWeight: FontWeight.w400,
            txtHeight: 1.3),
